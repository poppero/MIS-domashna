      ...
      {iscreateMeetingClicked ? (
        ...
        <>
          <input
            ...
            className="px-4 py-3 bg-gray-700 rounded-xl text-white w-full text-center"
          />
          {meetingIdError && (
      ...
      {(iscreateMeetingClicked || isJoinMeetingClicked) && (
        <>
          <input
            ...
            className="px-4 py-3 mt-5 bg-gray-700 rounded-xl text-white w-full text-center"
          />

          <button
            disabled={participantName.length < 3}
            className={`w-full ${
              participantName.length < 3 ? "bg-gray-700" : "bg-purple-400"
